...
const renderToday = () => {
  ...
  today.addEventListener("click", () => {
    hideProjectForm();
    const todayPrj = (0,_project__WEBPACK_IMPORTED_MODULE_0__.makeTodayProject)();
...
const renderThisWeek = () => {
  ...
  thisWeek.addEventListener("click", () => {
    hideProjectForm();
    const thisWeekPrj = (0,_project__WEBPACK_IMPORTED_MODULE_0__.makethisWeekProject)();
...
const currentProject = () => {
  ...
  if (projectId === "TDAY") {
    const projecttoreturn = (0,_project__WEBPACK_IMPORTED_MODULE_0__.makeTodayProject)();
    return projecttoreturn;
  }
  if (projectId === "TWEEK") {
    const projecttoreturn = (0,_project__WEBPACK_IMPORTED_MODULE_0__.makethisWeekProject)();
    return projecttoreturn;
  }
...
function ISOtoLocal(taskArr) {
  taskArr.forEach((task) => {
    if (task.date !== "") task.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(task.date);
  });
}
