...
/* harmony export */   "makeTodayProject": () => (/* binding */ makeTodayProject),
/* harmony export */   "makethisWeekProject": () => (/* binding */ makethisWeekProject),
...
function showProjectForm() {
  ...
  _taskdom_js__WEBPACK_IMPORTED_MODULE_1__.taskManipulator.hideTaskForm();
}
...
const renderToday = () => {
  ...
  today.addEventListener("click", () => {
    ...
    const todayPrj = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.makeTodayProject)();
    _taskdom_js__WEBPACK_IMPORTED_MODULE_1__.taskView.createNewTaskView(todayPrj);
...
const renderThisWeek = () => {
  ...
  thisWeek.addEventListener("click", () => {
    ...
    const thisWeekPrj = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.makethisWeekProject)();
    _taskdom_js__WEBPACK_IMPORTED_MODULE_1__.taskView.createNewTaskView(thisWeekPrj);
...
const currentProject = () => {
  ...
  if (projectId === "TDAY") {
    const projecttoreturn = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.makeTodayProject)();
    return projecttoreturn;
  }
  if (projectId === "TWEEK") {
    const projecttoreturn = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.makethisWeekProject)();
    return projecttoreturn;
  }
...
/* harmony export */   "makeProjectArrayForToday": () => (/* binding */ makeProjectArrayForToday),
...
function convertAllISOtoNormalDate(taskArr) {
  taskArr.forEach((value) => {
    if (value.date !== "") {
      value.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(value.date);
    }
  });
}
